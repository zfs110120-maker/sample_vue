...
export default {
  ...
  computed: {
    ...
    yAxisData({ chartData }) {
      ...
      if (chartData.wave1) {
        let yAxisArr = []
        chartData.wave1.forEach((item, index) => {
            const itemArr = { value: [] }
            itemArr.value[0] = chartData.datax[index]
            itemArr.value[1] = item
            yAxisArr.push(itemArr);
        })
        yData.push(yAxisArr)
      }
      ...
      if (chartData.wave2) {
        let yAxisArr = []
        chartData.wave2.forEach((item, index) => {
            const itemArr = { value: [] }
            itemArr.value[0] = chartData.datax[index]
            itemArr.value[1] = item
            yAxisArr.push(itemArr);
      ...
      if (chartData.wave3) {
        let yAxisArr = []
        chartData.wave3.forEach((item, index) => {
            const itemArr = { value: [] }
            itemArr.value[0] = chartData.datax[index]
            itemArr.value[1] = item
            yAxisArr.push(itemArr);
      ...
      if (chartData.wave4) {
        let yAxisArr = []
        chartData.wave4.forEach((item, index) => {
            const itemArr = { value: [] }
            itemArr.value[0] = chartData.datax[index]
            itemArr.value[1] = item
            yAxisArr.push(itemArr);
